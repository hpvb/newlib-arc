...
#define ARC_ESUCCESS	0	/* No error                             */
#define ARC_E2BIG		1	/* Argument list too long               */
#define ARC_EACCES		2	/* Permission denied                    */
#define ARC_EAGAIN		3	/* Resource temporarily unavailable     */
#define ARC_EBADF		4	/* Bad file descriptor                  */
#define ARC_EBUSY		5	/* Resource busy                        */
#define ARC_EFAULT		6	/* Bad address                          */
#define ARC_EINVAL		7	/* Invalid argument                     */
#define ARC_EIO		8	/* Input/output error                   */
#define ARC_EISDIR		9	/* Is a directory                       */
#define ARC_EMFILE		10	/* Too many open files                  */
#define ARC_EMLINK		11	/* Too many links                       */
#define ARC_ENAMETOOLONG	12	/* Filename too long                    */
#define ARC_ENODEV		13	/* No such device                       */
#define ARC_ENOENT		14	/* No such file or directory            */
#define ARC_ENOEXEC		15	/* Execute format error                 */
#define ARC_ENOMEM		16	/* Not enough space                     */
#define ARC_ENOSPC		17	/* No space left on device              */
#define ARC_ENOTDIR		18	/* Not a directory                      */
#define ARC_ENOTTY		19	/* Inappropriate I/O control operation  */
#define ARC_ENXIO		20	/* Media not loaded                     */
#define ARC_EROFS		21	/* Read-only file system                */
